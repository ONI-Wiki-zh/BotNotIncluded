...
# df.to_csv("strings_preinstalled_zh_klei.csv")
# df.to_json("strings_preinstalled_zh_klei.json", force_ascii=False, indent=1)
df_ele = df.copy()
...
df_ele.to_csv("strings_preinstalled_zh_klei_elements.csv")
df_ele.to_json("strings_preinstalled_zh_klei_elements.json", orient="records", lines=True, force_ascii=False)
df_ele.loc[:, ("context", "id")].to_json("strings_preinstalled_zh_klei_elements_en.json", orient="records", lines=True,
                                         force_ascii=False)
...
df_tag.to_csv("strings_preinstalled_zh_klei_tags.csv")
...
df_misc.to_json("strings_preinstalled_zh_klei_misc.json", orient="records", lines=True, force_ascii=False)
df_misc.loc[:, ("context", "id")].to_json("strings_preinstalled_zh_klei_misc_en.json", orient="records", lines=True,
                                          force_ascii=False)
...
df_crea.loc[:, ("context", "string")].to_json("strings_preinstalled_zh_klei_creatures.json", orient="records",
...
df_bu.loc[:, ("context", "string")].to_json("strings_preinstalled_zh_klei_buildings.json", orient="records", lines=True,
                                            force_ascii=False)
...
df_re.loc[:, ("context", "string")].to_json("strings_preinstalled_zh_klei_researches.json", orient="records",
                                            lines=True, force_ascii=False)
...
df_ui.loc[:, ("context", "string")].to_json("strings_preinstalled_zh_klei_ui.json", orient="records", lines=True,
                                            force_ascii=False)
